  ...
  it("should deny uploading a wrong file format", async () => {
    ...
    const res = await agent
      ...
      .attach(
        "avatar",
        fs.readFileSync(
          path.resolve(`${__dirname}/../../../helper/invalid_format.doc`)
        ),
        "avatar.doc"
      );
  ...
  it("should deny handling too large files", async () => {
    ...
    const res = await agent
      ...
      .attach(
        "avatar",
        fs.readFileSync(
          path.resolve(`${__dirname}/../../../helper/too_large.jpg`)
        ),
        "avatar.jpg"
      );
    res.should.have.status(500);
  ...
  it("should process JPGs", async () => {
    ...
    const res = await agent
      ...
      .attach(
        "avatar",
        fs.readFileSync(
          path.resolve(`${__dirname}/../../../helper/valid_jpg.jpg`)
        ),
        "avatar.jpg"
      );
  ...
  it("should process PNGs", async () => {
    ...
    const res = await agent
      ...
      .attach(
        "avatar",
        fs.readFileSync(
          path.resolve(`${__dirname}/../../../helper/valid_png.png`)
        ),
        "avatar.png"
      );
